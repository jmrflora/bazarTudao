...
// Mutate calls f(ctx, m).
func (f ItemOrdemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ItemOrdemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ItemOrdemMutation", m)
}

// The OrdemFunc type is an adapter to allow the use of ordinary
// function as Ordem mutator.
type OrdemFunc func(context.Context, *ent.OrdemMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OrdemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OrdemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OrdemMutation", m)
}

// The ProdutoFunc type is an adapter to allow the use of ordinary
// function as Produto mutator.
type ProdutoFunc func(context.Context, *ent.ProdutoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProdutoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProdutoMutation); ok {
		return f(ctx, mv)
	}
